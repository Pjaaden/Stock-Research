...
- **最近动态**（新→旧）：2026-09-02 霸王茶姬 2026Q2 v7（读数框架/直营核查/组织验证/SOTP估值，companies.json 写回）→ 2026-08-27 工作流优化（sessions/ 交接档案 + HANDOFF + 多设备规范）→ 2026-08-27 凌霄泵业 2026H1 报告 + 季度 CSV 建档 → 2026-08-26 本地化迁移与连通性测试 → 2026-08-25 工作流完整性审计
