...
- **最近动态**（新→旧）：2026-09-10 赛轮集团 2026H1 中报深度解析 v21 + 季度财报 CSV 建档（8节量化：数据边界对账/利润表深挖/现金流/海外产能/税率与GIoBE/估值重估，情景加权中枢16.00元；`data/quarterly/` 4份CSV，16项恒等式校验通过）→ 2026-09-02 霸王茶姬 2026Q2 v7（读数框架/直营核查/组织验证/SOTP估值，companies.json 写回）→ 2026-08-27 工作流优化（sessions/ 交接档案 + HANDOFF + 多设备规范）→ 2026-08-27 凌霄泵业 2026H1 报告 + 季度 CSV 建档 → 2026-08-26 本地化迁移与连通性测试
...
- `QUARTERLY_CSV_WORKFLOW.md`：季度财报 CSV 存档工作流（已建档：凌霄泵业 002884 → `凌霄泵业_002884/data/quarterly/`；赛轮集团 601058 → `赛轮集团_601058/data/quarterly/`）
