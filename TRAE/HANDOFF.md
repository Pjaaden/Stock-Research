...
1. 2026-09-10 赛轮集团 2026H1 中报深度解析 v21 + 季度财报 CSV 建档：8 节量化报告（数据边界对账/利润表深挖/资产负债与现金流/海外基地与产能/税率与GIoBE/估值重估/假设验证）；核心：Q2 营收 105.66 亿破百亿（验证假设①）、Q2 归母 11.04 亿低于 6/29 推演约 2 亿（汇兑净损失 2.56 亿 + 有效税率 14.65%）；情景加权中枢 16.00 元、中性净利下修至 48 亿；`data/quarterly/` 建档 4 份 CSV（16 项恒等式校验通过）；log-20260910-001/002 登记
